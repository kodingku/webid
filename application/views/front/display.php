	...
	<div class="slider g-mb-30">
		<div><img src="<?php echo base_url();?>assets/img/slider/dedicated.jpg" class="img-fluid" style="width: 100%;"></div>
		<div><img src="<?php echo base_url();?>assets/img/slider/fo.jpg" class="img-fluid" style="width: 100%;"></div>
		<div><img src="<?php echo base_url();?>assets/img/slider/gudangapp.jpg" class="img-fluid" style="width: 100%;"></div>
		<div><img src="<?php echo base_url();?>assets/img/slider/interkoneksi.jpg" class="img-fluid" style="width: 100%;"></div>
		 <div><img src="<?php echo base_url();?>assets/img/slider/pelatihan.jpg" class="img-fluid" style="width: 100%;"></div>
		  <div><img src="<?php echo base_url();?>assets/img/slider/server.jpg" class="img-fluid" style="width: 100%;"></div>
	</div>
<div class="container">
	<div class="row" style="margin-top: 100px;margin-bottom: 100px; ">
		<div class="col-md-3 text-center">
			<img src="<?php echo base_url();?>assets/img/icon/service.png" class="img-fluid">
			<p>
				Kami Indotrans Data memberikan layanan informasi teknisi bagi PELANGGAN selama 24 jam x 7 hari. Anda bisa langsung menghubungi kami di call center, whatsapp ataupun live chat.
			</p>
		</div>
		<div class="col-md-3 text-center">
			<img src="<?php echo base_url();?>assets/img/icon/jaringan.png" class="img-fluid">
			<p>
				Jaminan bahwa bandwidth yang didapatkan sesuai dengan kapasitas bandwidth yang telah disepakati, tanpa adanya pemakaian bersama (sharing).
			</p>
		</div>
		<div class="col-md-3 text-center">
			<img src="<?php echo base_url();?>assets/img/icon/kontent.png" class="img-fluid">
			<p>
				Kami menjamin Service Level Agremeent bagi pengguna produk Indotrans Data sebesar 99%. Kami berkomitmen untuk menjamin keamanan dari kerusakan jaringan.
			</p>
		</div>
		<div class="col-md-3 text-center">
			<img src="<?php echo base_url();?>assets/img/icon/teknisi.png" class="img-fluid">
			<p>
	...
	<!-- Powered By -->
      <section id="powered" class="text-center g-py-10">
        <div class="container-fluid">
          <div class="container">
            <div class=" u-heading-v2-4--bottom g-brd-primary g-mb-10">
              <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-size-30 g-mb-minus-10">Pelanggan Kami</h2>
            </div>
          </div>
        

         <div id="carouselCus3" class="js-carousel g-mt-30 g-mb-20"
               data-autoplay="true"
               data-infinite="true"
               data-slides-show="6">
     ...
     <section id="powered" class="text-center g-py-80">
        <div class="container-fluid">
          <div class="container g-width-780 g-mb-60">
            <div class=" u-heading-v2-4--bottom g-brd-primary g-mb-45">
              <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-size-30 g-mb-minus-10">Layanan Kami Di Dukung Oleh</h2>
            </div>
          </div>
        

         <div id="carouselCus3" class="js-carousel g-mt-30 g-mb-30"
               data-autoplay="true"
               data-infinite="true"
               data-slides-show="6">
     		 <div class="js-slide g-brd-around g-brd-gray-light-v1--hover g-transition-0_2 g-mx-10 g-my-1">
